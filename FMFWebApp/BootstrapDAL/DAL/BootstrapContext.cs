...
namespace BootstrapWebApplication.DAL
{
    ...
    {
        //public virtual DbSet<ALKA> Alkas { get; set; }
        ...
        public virtual DbSet<LundinMembershipPaymentBooking> LundinMembershipPaymentBookings { get; set; }
        public virtual DbSet<LundinAlkaPaymentBooking> LundinAlkaPaymentBookings { get; set; }

        public BootstrapContext()
            : base("name=BootstrapWebApplicationContext")//FMFWebAppContext")
        {
