...
namespace BootstrapWebApplication.Models.Old
{
    ...
    public partial class ARBTYPER
    {
        public int ARBTYPER_Id { get; set; }
        public string ARB_TYPE { get; set; }
        public string ARB_TEKST { get; set; }
        public Nullable<decimal> PCT_ANDEL { get; set; }
        public Nullable<decimal> KR_TILLAG { get; set; }
