...
var GridHandler = function (_gridId, _searchId, _saveButtonId) {
    var self = this;
    ...
    $(!_saveButtonId ? "#GridSaveSettings" : _saveButtonId).click(function (e) {
        e.preventDefault();
        //alert("saved grid settings");
        localStorage["kendo-grid-" + self.gridId + "-options"] = kendo.stringify(self.grid.getOptions());
    });
    if (localStorage["kendo-grid-" + self.gridId + "-options"]) {
        var gridSettings = JSON.parse(localStorage["kendo-grid-" + self.gridId + "-options"]);
        console.log("Grid " + self.gridId + " settings: ");
        console.log(self.grid);
        //self.grid.setOptions(gridSettings);
    }
    self.Grid = function () {
        return self.grid;
    };
    ...
    self.setSaveButtonId = function (id) {
...
function CreateDataSource(pageSize, url, filterCode) {
    var dataSource = new kendo.data.DataSource({
        ...
        transport: {
            read: {
                url: url,
                data: {
                    filter: function () { return $(filterCode).data("kendoAutoComplete").value(); }
                },
                dataType: "json",
                type: "GET"
            }
