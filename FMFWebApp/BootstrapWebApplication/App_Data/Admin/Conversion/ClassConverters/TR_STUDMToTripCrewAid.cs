...
{
    public class TR_STUDMToTripCrewAid
    {
        public TR_STUDMToTripCrewAid(BootstrapContext db, TR_STUDM o, ConverterData data)
        {
            ...
            var tripCrewAid = new TripCrewAid()
            {
            ...
            //db.TripCrewAids.Add(tripCrewAid);
