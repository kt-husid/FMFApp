...
{
    public class StatToStatus
    {
        public StatToStatus(BootstrapContext db, STAT o, ConverterData data)
        {
            ...
            var status = new Status()
            {
                ...
                Code = ("" + o.ID).Trim().Length > 0 ? o.ID : null,
                ...
                DLISTA = o.DLISTA,
                BLISTA = o.BLISTA,
                YearList = o.ARS_LISTI,
                IsOnYearList = o.ARS_LISTI.ToLower().Equals("j")
            };
