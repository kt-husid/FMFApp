...
{
    public class ShipAddressController : Controller<Address>
    {
        /// <summary>
        ...
        {
            return GetRelatedDataForParent<Ship>(id, "Addresses");
        }
        ...
        {
            Ship ship = null;
            var result = CreateRelatedObjectUsingViewModel<Ship, Address>(vmObj.ParentId, vmObj, (parent) =>
            {
                ship = parent;
            ...
            if (ship != null)
            {
                var address = ship.PrimaryAddress;
                if (address != null)
                {
                    ...
                    ship.CountryCode = country != null ? country.Code : "";
                    ship.CountryName = country != null ? country.Name : "";
                    ship.AddressLine = address != null ? address.AddressLine1 + " " + address.AddressLine2 : "";
                    ship.PostalCode = postal != null ? new Nullable<int>(postal.Code) : null;
                    ship.CityName = postal != null ? postal.CityName : "";
        ...
        {
            Ship ship = null;
            var result = UpdateRelatedObjectUsingViewModel<Ship, Address>(vmObj.ParentId, vmObj, (parent) =>
            {
                ship = parent;
        ...
        {
            //return DeleteObject<Address, Ship>(vmObj.Id, vmObj.ParentId);
